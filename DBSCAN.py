...
dataset = [(float(_initalData[i]), float(_initalData[i + 1])) for i in range(1, len(_initalData) - 1, 3)]
...
# 算法模型
def DBSCAN(Data, e, Minpts):  # 数据 邻域参数（e, Minpts）
